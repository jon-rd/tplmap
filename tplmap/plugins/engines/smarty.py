from tplmap.plugins.languages import php
    ...
    def init(self):
        ...
        self.update_actions(
            {
                "render": {
                    ...
                    % {"r1": rand.randints[0], "r2": rand.randints[2]},
                },
                "evaluate": {"call": "render", "evaluate": """{php}%(code)s{/php}"""},
                "evaluate_blind": {
                    "call": "inject",
        ...
        self.set_contexts(
            [
                ...
                {
                    "level": 5,
                    "prefix": '%(closure)s var="" value=""}{assign var="" value=""}',
                    "suffix": "",
                    "closures": php.ctx_closures,
                },
                # Comments
