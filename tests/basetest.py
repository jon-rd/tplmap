...
class BaseTest(object):
    ...
    def test_reflection(self):
        ...
        for reflection_test in self.reflection_tests:
            ...
            obj, data = self._get_detection_obj_data(
                self.url % template, level, clevel, technique="R"
            )
    ...
    def test_blind(self):
        ...
        for blind_test in self.blind_tests:
            ...
            obj, data = self._get_detection_obj_data(
                self.url_blind % template, level, clevel, technique="T"
            )
    ...
    def test_upload_blind(self):
        ...
        obj, data = self._get_detection_obj_data(self.url_blind, technique="T")
